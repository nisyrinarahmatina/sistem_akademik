...
<div id="layoutSidenav">
    ...
    <main>
        <div class="container-fluid px-4">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex gap-2">
                                <a href="{{ route('jadwal.editJadwalMurid', $data->id) }}" class="btn btn-primary">Edit</a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <form action="{{ route('jadwal.destroyJadwalMurid', $data->id) }}" method="POST">
                                        @csrf
                                        @method('DELETE')
            ...
            <a href="{{ route('jadwal.createJadwalMurid') }}" class="btn btn-primary mt-3">Tambah Jadwal</a>
