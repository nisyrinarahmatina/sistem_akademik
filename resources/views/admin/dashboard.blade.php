...
<head>
    ...
    <style>
        ...
        .card:hover {
            cursor: pointer;
            background-color: rgb(23, 50, 132); /* Change this to any hover color you like */
        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <a href="{{ url('/inputjadwal') }}" class="card text-dark bg-white text-decoration-none">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center mb-3">
                                    <i class="fa-solid fa-calendar-week fa-2x mb-2"></i> 
                                    <h5 class="card-title mb-0">Input Jadwal</h5>
                                </div>
                    ...
                    <!-- Input Nilai Card -->
                    <div class="col-md-4 col-lg-3 mb-4">
                        <a href="{{ url('/inputnilai') }}" class="card text-dark bg-white text-decoration-none shadow">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center mb-3">
                                    <i class="fa-solid fa-file-import fa-2x mb-2"></i>
                                    <h5 class="card-title mb-0">Input Nilai</h5>
                                </div>
                                <hr class="bg-light my-3">
                            </div>
                        </a>
                    </div>                    <!-- Mode Daftar Card --> 


                    <div class="col-md-4 col-lg-3 mb-4">
                        <a href="{{ url('/modedaftar') }}" class="card text-dark bg-white text-decoration-none shadow">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center mb-3">
                                    <i class="fa-solid fa-user-plus"></i>
                                    <h5 class="card-title mb-0">Mode Daftar</h5>
                                </div>
                                <hr class="bg-light my-3">
                            </div>
                        </a>
