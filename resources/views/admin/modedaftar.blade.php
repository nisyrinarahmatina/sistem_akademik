...
<div id="layoutSidenav">
    ...
    <main>
        <div class="container">
        <h1 class="mt-4 mb-5">Mode Daftar</h1>
        ...
        @csrf
            ...
            <div class="mb-4">
                <label for="kelas" class="form-label">ID Fingerprint</label>
                <input type="text" class="form-control"  name="id_fingerprint" required>
            </div>

            <div class="mb-4">
                <label for="kelas" class="form-label">Username</label>
