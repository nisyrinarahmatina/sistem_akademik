...
<div id="layoutSidenav">
    ...
    <main>
        <div class="container">
        <h1 class="mt-4 mb-5">Tambah Nilai</h1>
        <form action="{{ route('nilai.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="file_nilai" class="form-label">File Nilai</label>
                <input type="file" class="form-control" id="file_nilai" name="file_nilai" accept=".pdf">
            </div>
                <button type="submit" class="btn btn-primary mb-3">Simpan</button>
                <a href="{{ route('nilai.index') }}" class="btn btn-secondary mb-3">Batal</a>
        </form>
        @if ($errors->any())
