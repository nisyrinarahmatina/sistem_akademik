        ...
        <div class="container-fluid px-4">
            ...
            <div class="row">
                <div class="d-flex flex-column align-items-center">
                    ...
                    <a href="{{ url('/jadwalmengajar') }}" class="card text-dark bg-white text-decoration-none shadow">
            ...
            <div class="col-md-3 mb-4">
                <a href="{{ url('/rekapnilai') }}" class="card text-dark bg-white text-decoration-none shadow">
                    <div class="card-body text-center">
                        <i class="fas fa-list"></i>
                        <h5 class="card-title mb-2">Rekap Nilai</h5>
                    </div>
                </a>
            </div>

            <div class="col-md-3 mb-4">
                <a href="/presensimurid" class="card text-dark bg-white text-decoration-none shadow">
                    <div class="card-body text-center">
                        <i class="fa-solid fa-user"></i>
                        <h5 class="card-title mb-2">Presensi Murid</h5>
                    </div>
                </a>
            </div>
        </div>
