...
<div id="layoutSidenav">
    ...
    <main>
        <div class="container">
            <form action="{{ url('/rekapnilai') }}" method="GET" class="mt-5 mb-3">
            ...
            <div class="card mt-3">
                <h5 class="card-header bg-primary text-white text-center">Rekap Nilai</h5>
                <div class="card-body">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $data->kelas }}</td>
                                <td>
                                    <a href="{{ asset($data->file_nilai) }}" target="_blank">
                                    Lihat Rapor
                                </td>
                            </tr>
                            @empty
                            <tr>
                                <td colspan="7" class="text-center text-muted">@lang('Nilai belum tersedia.')</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
